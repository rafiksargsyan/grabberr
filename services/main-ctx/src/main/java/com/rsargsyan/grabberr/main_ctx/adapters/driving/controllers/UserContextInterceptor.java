...
import com.rsargsyan.grabberr.main_ctx.core.app.AuthService;
...
public class UserContextInterceptor implements HandlerInterceptor {
  ...
  public boolean preHandle(HttpServletRequest request, HttpServletResponse response,
    ...
    if (principal instanceof Jwt jwt) {
      ...
      String userProfileId = accountId != null
          ? authService.getUserProfileId(externalId, accountId) : null;
      ...
      UserContextHolder.set(authService.getUserContextByApiKey(customApiKey.getApiKeyId()));
    }
